var FlappyBird = (function () {
    ...
    FlappyBird.prototype.initData = function () {
    ...
    FlappyBird.prototype.genPipe = function (x) {
    ...
    FlappyBird.prototype.birdControl = function () {
    ...
    FlappyBird.prototype.landMove = function () {
    ...
    FlappyBird.prototype.collisionDetection = function () {
        for (var i = 0; i < 4; i++) {
    ...
    FlappyBird.prototype.birdLanded = function () {
    ...
    FlappyBird.prototype.checkAddScore = function () {
        var dis = 1000;
        var pos;
        for (var i = 0; i < 4; i++) {
    ...
    FlappyBird.prototype.printScore = function () {
        while (this.number.length > 0) {
            this.stage.removeChild(this.number.pop());
        }
        var s = this.score;
    ...
    FlappyBird.prototype.onWindowResized = function (event) {
        this.renderer.resize(window.innerWidth, window.innerHeight);
    };
    FlappyBird.prototype.onMouseDown = function (event) {
    ...
    FlappyBird.prototype.onTouchStart = function (event) {
        event.preventDefault();
        if (!this.isGameOver) {
            if (!this.isRunning) {
                this.start();
